  ...
  <div class="nav-bar">
    <div class="nav-bar__container">
      <div class="nav-bar__son nav-bar__left">
        <div class="nav-bar__item home-button-container" @click="toHome">
          <img src="/favicon.ico" alt="" draggable="false">
          <span>Sakura</span>
        </div>
      </div>
      <div class="nav-bar__son nav-bar__right">
        <div class="nav-bar__item intr-button-container right-item" @click="toIntr" ref="intr">
          <span>介绍</span>
        </div>
        <div class="nav-bar__item docu-button-container right-item" @click="toDocu" ref="docu">
          <span>文档</span>
        </div>
        <div class="nav-bar__item edit-button-container right-item" @click="toEdit" ref="edit">
          <span>编辑</span>
        </div>
        <div class="nav-bar__item github-button-container right-item">
          <a href="https://github.com/SakuraLong/sakuraRenderer" target="_blank">仓库</a>
          <!-- <span>仓库</span> -->
        </div>
      </div>
    </div>
